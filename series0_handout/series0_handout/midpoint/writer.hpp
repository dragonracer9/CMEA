...
void writeToFile(const std::string& filename,
    ...
    // Set highest possible precision, this way we are sure we are    <-- this sentence cuts off in the middle. I presume you were saying that it ensures maximum precision for convergence?
